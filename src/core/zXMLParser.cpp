 ...
 * \return 返回s
 */
std::string & zXMLParser::dump(_xmlNode* dumpNode,std::string & s ,bool head)
{
 ...
 */
_xmlNode* zXMLParser::getRootNode(const char *rootName)
{
	if(doc == NULL) return NULL;

	//得到根节点
	_xmlNode* cur = xmlDocGetRootElement(doc);
	//准备起始节点
	if(rootName!=NULL)
 ...
 */
_xmlNode* zXMLParser::getChildNode(_xmlNode* parent, const char *childName)
{
	if(parent==NULL) return NULL;
	_xmlNode* retval=parent->children;
	if(childName)
		while(retval)
		{
 ...
 */
_xmlNode* zXMLParser::getNextNode(_xmlNode* node,const char *nextName)
{
	if(node==NULL) return NULL;
	_xmlNode* retval=node->next;
	if(nextName)
		while(retval)
		{
 ...
 * \return 子节点的数量
 */
unsigned int zXMLParser::getChildNodeNum(_xmlNode* parent, const char *childName)
{
	int retval=0;
	if(parent==NULL) return retval;
	_xmlNode* child=parent->children;
	if(childName)
		while(child)
		{
 ...
 */
_xmlNode* zXMLParser::newRootNode(const char *rootName)
{
	if (NULL == doc)
		return NULL;

	_xmlNode* root_node = xmlNewNode(NULL, (const xmlChar *)rootName);
 ...
 * \return 返回添加节点的指针
 */
_xmlNode* zXMLParser::newChildNode(_xmlNode* parent, const char *childName, const char *content)
{
	if (NULL == parent)
		return NULL;
...
bool zXMLParser::newNodeProp(_xmlNode* node,const char *propName,const char *prop)
{
	if (NULL == node)
		return false;
...
bool zXMLParser::newNodeProp(_xmlNode* node,const char *propName,const char *prop,const char* encoding)
{
	if (NULL == node)
		return false;
 ...
 */
bool zXMLParser::getNodePropNum(_xmlNode* node,const char *propName,void *prop, const int propSize)
{
	char *temp=NULL;
	bool ret=true;
 ...
 * \return  成功返回true,否则返回false
 */
bool zXMLParser::getNodePropStr(_xmlNode* node,const char *propName,void *prop,int propSize)
{
	char *temp=NULL;
	bool ret=true;
	if(node==NULL || prop==NULL || propName==NULL) return false;
 ...
 * \return  成功返回true,否则返回false
 */
bool zXMLParser::getNodePropStr(_xmlNode* node,const char *propName,std::string &prop)
{
	char *temp=NULL;
	bool ret=true;
...
bool zXMLParser::getNodePropTime(_xmlNode* node,const char *propName,time_t &prop)
{
	std::string str;
...
bool zXMLParser::getNodeContentTime(_xmlNode* node,time_t &prop)
{
	std::string str;		
 ...
 * \return  成功返回true,否则返回false
 */
bool zXMLParser::getNodeContentNum(_xmlNode* node,void *content, int contentSize)
{
	char *temp=NULL;
	bool ret=true;
	if(node==NULL || content==NULL) return false;
	_xmlNode* text=node->children;
	while(text!=NULL)
	{
 ...
 * \return  成功返回true,否则返回false
 */
bool zXMLParser::getNodeContentStr(_xmlNode* node,void *content, const int contentSize)
{
	char *temp=NULL;
	bool ret=true;
	if(node==NULL || content==NULL) return false;
 ...
 * \return  成功返回true,否则返回false
 */
bool zXMLParser::getNodeContentStr(_xmlNode* node,std::string &content)
{
	char *temp=NULL;
	bool ret=true;
...
bool zXMLParser::isNodeName(_xmlNode* node, const std::string& name)
{
