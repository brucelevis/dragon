...
class ServerTask : public zTCPTask , public MessageQueue<>
{
	...
	private:
		...
		bool msgParse_Record(const CMD::t_NullCmd *ptNullCmd, const unsigned int nCmdLen);
		bool msgParse_Scene(const CMD::t_NullCmd *ptNullCmd, const unsigned int nCmdLen);
